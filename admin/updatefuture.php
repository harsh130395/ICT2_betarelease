		...
		<div class="container">
			...
			<?php
									...
									if(isset($_POST['action']))
									{
										...
										move_uploaded_file($file_tmp,"futureevents/".$img);

										$query="Update `futureevents` Set `title`='$title', `Image`='$img', `Content`='$content', `Author`='$name' Where id='$data_set'";
									...
									<?php
									$query="SELECT * FROM `futureevents` Where id='".$_GET['get_id']."'";
									$run=mysqli_query($connection,$query);
