                            ...
                            <ul class="widget widget-menu unstyled">
                               <!-- <li><a href="#"><i class="menu-icon icon-dashboard"></i>Dashboard
								...
								<li><a href="subscrib.php"><i class="menu-icon icon-bullhorn"></i>Manage Subscribes</a>
                                	...
                                	<li class="active"><a href="contact-us.php"><i class="menu-icon icon-bullhorn"></i>Manage Contact</a>
                                </li>
                            </ul>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									?>
                                     <tr class="odd gradeX">
											...
											<td class="center"><a href="delete.php?contect=<?= $id;?>" class="btn btn-default">Delete</a></td>
										</tr>
                                 <?php
									}
									?>
